...
import { BMDialoForm } from "./dialog-form/bm-dialog-form";
import { BMDialogDeleteConfirmation } from "./dialog-form/bm-dialog-delete-confirmation";
...
function BarangMelekat(): ReactElement {
  ...
  function actionButton(rowData: UpsertBarangMelekatSchema): React.ReactNode {
    ...
    <div className="grid">
      <div className="col-12">
        <div className="card">
          ...
          >
            <Column
              body={(rowData : UpsertBarangMelekatSchema) => (
                actionButton(rowData)
              )}
              header="Actions"
              style={{"width" : "3rem"}}
            />
            <Column field="ati_name" header="Nama" style={{ minWidth: "20rem" }} />

            <Column
              body={(rowData) => (
                checkboxUI(rowData.ati_is_default)
              )}
              dataType="boolean"
            ...
            <Column
              body={(rowData) => (
                checkboxUI(rowData.ati_is_active)
              )}
              dataType="boolean"
              field="ati_is_active"
              header="Aktif ?"
